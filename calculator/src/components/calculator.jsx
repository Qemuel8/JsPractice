    ...
    render() { 
        return (
            <div id='app'>
                ...
                <input id='display' value={this.state.displayData} ></input>

                    <div id='numbers'>
                    {this.state.buttons.numbers.map((item) => (
                    <button id={item.id} onClick={() => this.handleInput(item.display ,this.state)}>{item.display}</button>
                ))}
                    ...
                    <div id='operands'>
                        {this.state.buttons.operands.map((item) => (
                            <button id={item.id} onClick={() => this.handleInput(item.display)}>{item.display}</button>
                        ))}
                    </div>
                </div>
            </div>
